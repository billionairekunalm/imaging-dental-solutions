...
import { ArrowLeft, CheckCircle2, Shield, Activity, Clock } from "lucide-react";
import Link from "next/link";
import Footer from "@/components/Footer";
import { motion } from "framer-motion";

const benefits = [
  "Sub-millimeter precision for exact diagnosis",
  "Lower radiation dose compared to traditional CT",
  "Comprehensive 3D view of teeth, jaw, and nerves",
  "Quick scan time (typically under a minute)"
];
...
const useCases = [
  ...
  "Airway & Sleep Apnea Studies",
  "TMJ Analysis",
  "Root Canal Therapy Planning"
];

export default function CBCTService() {
  return (
    <main className="min-h-screen bg-slate-50 font-sans selection:bg-[#0288D1]/20">
        ...
        <div className="max-w-6xl mx-auto px-6 pt-12 pb-24 relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 border border-white/20 text-sm font-medium mb-6 backdrop-blur-md">
              ...
              <span className="text-white/90">Gold Standard in Dental Imaging</span>
            </div>
            ...
            <p className="text-lg text-white/80 leading-relaxed mb-8">
              Experience the highest level of diagnostic clarity. Our advanced CS 9600 CBCT machines capture highly detailed 3D representations of your oral and maxillofacial structures.
            </p>
          ...
          <motion.div
            ...
            className="relative h-[400px] lg:h-[500px] rounded-3xl overflow-hidden border border-white/10 shadow-2xl"
          >
            <img src="/images/cs9600.jpg" alt="CS 9600 CBCT Machine" className="absolute inset-0 w-full h-full object-cover" />
      ...
      <section className="py-24 bg-white">
        <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-16">
          ...
          <div className="lg:col-span-7">
            <h2 className="text-3xl font-bold text-slate-900 mb-6">What is a 3D CBCT Scan?</h2>
            <p className="text-slate-600 text-lg leading-relaxed mb-8">
              Cone Beam Computed Tomography (CBCT) is a revolutionary imaging technique that provides three-dimensional views of your teeth, jawbone, nerve pathways, and soft tissues in a single scan. Unlike standard 2D x-rays, CBCT allows dentists to see exact anatomical structures in high definition without distortion or magnification.
            </p>
      ...
      <section className="py-20 bg-slate-50 border-t border-slate-100">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <Clock className="w-12 h-12 text-[#0288D1] mx-auto mb-6" />
          <h2 className="text-3xl font-bold text-slate-900 mb-6">How to Prepare</h2>
          <p className="text-slate-600 text-lg leading-relaxed mb-8">
            A CBCT scan requires virtually no special preparation. You may be asked to remove jewelry, eyeglasses, or hearing aids, as metal objects may interfere with image quality. The scan itself is completely painless and typically takes less than a minute.
          </p>
